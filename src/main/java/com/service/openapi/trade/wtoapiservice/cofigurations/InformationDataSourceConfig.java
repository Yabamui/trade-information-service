...
@EnableJpaRepositories(
        basePackages = {"com.service.openapi.trade.wtoapiservice.repositories.information"},
...
public class InformationDataSourceConfig extends HikariConfig {
    ...
    public EntityManagerFactory entityManagerFactoryInformation() {
        ...
        factoryBean.setPackagesToScan("com.service.openapi.trade.wtoapiservice.entities.information");
