package com.service.openapi.trade.wtoapiservice.clients;

import com.service.openapi.trade.wtoapiservice.cofigurations.WtoApiClientConfig;
import com.service.openapi.trade.wtoapiservice.models.wtoapiclient.DataRequest;
...
public interface WtoTimeSeriesApiClient {
     ...
     */
    @GetMapping("/v1/data")
    Response getData(@SpringQueryMap DataRequest request);
}
